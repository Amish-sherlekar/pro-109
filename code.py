...
print("{}% of data for math score lies between first standard deviation".format(len(math_score_data_within_first_standard_deviation)*100/len(math_score_list)))
print("{}% of data for math score lies between second standard deviation".format(len(math_score_data_within_second_standard_deviation)*100/len(math_score_list)))
print("{}% of data for math score lies between third standard deviation".format(len(math_score_data_within_third_standard_deviation)*100/len(math_score_list)))
...
print("{}% of data for reading score lies between first standard deviation".format(len(reading_score_data_within_first_standard_deviation)*100/len(reading_score_list)))
print("{}% of data for reading score lies between second standard deviation".format(len(reading_score_data_within_second_standard_deviation)*100/len(reading_score_list)))
print("{}% of data for reading score lies between third standard deviation".format(len(reading_score_data_within_third_standard_deviation)*100/len(reading_score_list)))
...
print("{}% of data for written score lies between first standard deviation".format(len(written_score_data_within_first_standard_deviation)*100/len(written_score_list)))
print("{}% of data for written score lies between second standard deviation".format(len(written_score_data_within_second_standard_deviation)*100/len(written_score_list)))
print("{}% of data for written score lies between third standard deviation".format(len(written_score_data_within_third_standard_deviation)*100/len(written_score_list)))
